...
<script>
 ...
 <!-- CreditKasa -->  
    ...
    <!-- Case: creditplus -->
				<div class="cases st0">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1844?aid=63223" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-creditplus.svg" alt="creditplus" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1844?aid=63223" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div> 
				...
				<div class="cases">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1960?aid=63223" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/gofingo_logo.png" alt="GoFinGo" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1960?aid=63223" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1261?aid=63223" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-mycredit.png" alt="MyCredit" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1261?aid=63223" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases st0">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/2187?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/e-cash-logo.png" alt="kachay" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/2187?aid=65264&dlink=https://cashinski.com.ua/ru/june-bomb/" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
