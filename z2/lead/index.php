...
<head>
	<meta charset="utf-8">
	<title>Онлайн-займ на карту, не выходя из дома</title>
    <meta name="description" content="Оформите займ онлайн до 15000 грн на свою банковскую карту ⭐ Выдаем займ за 5-7 минут без залога и справок" >
...
<script>
  ...
  fbq('init', '1082553058592260');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=1082553058592260&ev=PageView&noscript=1"
/></noscript>
...
<body class="interactive-header hidden-body">
...
<!-- End Google Tag Manager (noscript) -->
	<div class="wrapper">
        ...
        <div class="hero">
			<div class="hero__message">займ на карту, не&nbsp;выходя из&nbsp;дома</div>
								...
								<div class="container">
									<div class="row">
										<div class="col-sm-6 col-lg-7">
											<h3 class="hero__title">Получите до 15000 грн на свою карту</h3>
											<p class="hero__text">Первый кредит – под 0,01%</p>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="calculator calculator--fixed">
						...
						<h3>Оформить кредит</h3>
                            ...
                            <div class="calculator__group">
								<h4 class="calculator__name">Cумма займа</h4>
								...
								<div class="range-slider"  id="slider-money" data-value="500" data-min="500" data-max="15000"></div>
						...
						<input type="hidden" name="access-token" value="2a71b8b953216b8138077ee06cd4b815"/>
                        ...
                        <div class="calculator__preivew">
                            ...
                            <a id="submit" onclick="fbq('track', 'CompleteRegistration');" data-href="<?php echo $url; ?>" class="btn btn--primary btn--lg" href="../index.php?utm_source=<?php echo $utm_source;?>&utm_medium=<?php echo $utm_medium;?>&utm_campaign=<?php echo $utm_campaign;?>&utm_term=<?php echo $utm_term;?>&utm_content=<?php echo $utm_content;?>">Отправить заявку</a>
							</div>
	...
	<input type="checkbox" id="confirmation" checked="">
		...
		<div class="container">
			<div class="block">
				<h2 class="heading">Как получить деньги?</h2>
				<div class="tabs tabs--md">
					<ul class="nav nav-tabs" role="tablist">
						<li class="tab__item active" role="presentation"><a class="tab__link" href="#get-credit" aria-controls="get-credit" role="tab" data-toggle="tab">Как получить займ</a>
						</li>
						<li class="tab__item" role="presentation"><a class="tab__link" href="#pay-credit" aria-controls="pay-credit" role="tab" data-toggle="tab">Как погасить займ</a>
						</li>
					</ul>
							...
							<div class="row hidden-xs">
								<div class="col-sm-6 col-md-3">
									<div class="feature feature--big">
										...
										</div><span class="feature__count">1</span><span class="feature__info">Укажите <br> сумму и срок займа</span>
								...
								<div class="col-sm-6 col-md-3">
									<div class="feature feature--big">
										...
										</div><span class="feature__count">2</span><span class="feature__info">Отправьте анкету <br> и укажите карту</span>
										<p class="feature__text">Один раз при регистрации.
											<br>Для последующих займов
								...
								<div class="col-sm-6 col-md-3">
									<div class="feature feature--big">
										...
										</div><span class="feature__count">3</span><span class="feature__info">Ожидайте получение <br> решения</span>
										<p class="feature__text">Решения принимаются
											<br>ежедневно с 8:00 до 21:00,
											<br>7 дней в неделю</p>
									</div>
								</div>
								<div class="col-sm-6 col-md-3">
									<div class="feature feature--big">
							...
							<div class="row hidden-xs">
								<div class="col-sm-6 col-md-3">
									<div class="feature feature--big">
										...
										</div><span class="feature__count">1</span><span class="feature__info">Ознакомьтесь с <br> информацией по займу</span>
								...
								<div class="col-sm-6 col-md-3">
									<div class="feature feature--big">
										...
										<p class="feature__text">Если на счету ноль,
											<br>займ считается закрытым
											<br>и можно оформить новый займ</p>
									</div>
								</div>
								<div class="col-sm-6 col-md-3">
									<div class="feature feature--big">
										<div class="feature__media">
											<img src="images/feature-1.png">
										</div><span class="feature__count">4</span><span class="feature__info">Оформите новый займ</span>
										<p class="feature__text">Заявка на последующие займы
				...
				<div class="centered-block"><a class="btn btn--primary btn--effect scrollup" href="#">Оформить займ</a>
				</div>
			</div>
		</div>
		<!--<div class="box">
						...
						<div class="tabs tabs--section tabs--limit">
							<ul class="nav nav-tabs tab-pagination">
								<li class="tab__item active">
									<a class="tab__link" href="#" data-reference="1"> <span class="tab_holder">Какие условия онлайн займования в&nbsp;Groshiua.online?</span>
									</a>
								</li>
								<li class="tab__item">
									<a class="tab__link" href="#" data-reference="2"> <span class="tab_holder">Что нужно для получения займа?</span>
									</a>
								</li>
								<li class="tab__item">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-3">
										<div class="feature feature--big">
											...
											<p class="feature__text">Мы выдаем займы только
								...
								<div class="row">
									<div class="col-sm-12 col-md-7">
										<div class="row">
											<div class="col-sm-4">
												<div class="feature feature--big">
													<img class="feature__icon" src="images/trial.svg"><span class="feature__info">займы от 0%<br />новым клиентам </span>
													<p class="feature__text">займ под 0% новым клиентам — обыч&shy;ная прак&shy;тика для микро&shy;займ&shy;ных ком&shy;паний </p>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="feature feature--big">
									...
									<div class="col-sm-12 col-md-5">
										<div class="row">
											<div class="col-sm-4 col-sm-offset-2 col-md-6 col-md-offset-0">
												<div class="feature feature--big">
													<img class="feature__icon" src="images/clock.svg"><span class="feature__info">Быстрое решение <br> по займу</span>
													<p class="feature__text">Для первого обращения -
														<br>до 15 минут, для
														<br>последующих займов -
														<br>до 5 минут</p>
												</div>
											</div>
											<div class="col-sm-4 col-md-6">
												<div class="feature feature--big">
													<img class="feature__icon" src="images/week.svg"><span class="feature__info">займы на срок от&nbsp;1 дня</span>
													<p class="feature__text">
                                                    Вы можете взять займ на&nbsp;срок от 1 до 60 дней
														</p>
												</div>
											</div>
										</div>
						...
						<div class="accordion panel-group" id="feature-accordion" role="tablist" aria-multiselectable="true">
							<div class="panel">
								<div class="panel-heading" id="feature-1">
									<h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#feature-accordion" href="#feature-which" aria-expanded="true" aria-controls="feature-which">Какие условия онлайн займования в&nbsp;Groshiua.online?</a></h4>
								</div>
									...
									<div class="panel-body">
										<div class="swiper-container mobile-feature">
											<div class="swiper-wrapper">
												...
												<div class="swiper-slide">
													<div class="feature feature--big">
														<img class="feature__icon" src="images/clock-alt.svg"><span class="feature__info">Решения по займам <br> с 8:00 до 21:00</span>
							...
							<div class="panel">
								<div class="panel-heading" id="feature-2">
									<h4 class="panel-title"><a class="collapsed" role="button" data-toggle="collapse" data-parent="#feature-accordion" href="#feature-what" aria-expanded="false" aria-controls="feature-what">Что нужно для получения займа?</a></h4>
								</div>
									...
									<div class="panel-body">
										<div class="swiper-container mobile-feature">
											<div class="swiper-wrapper">
												<div class="swiper-slide">
													<div class="feature feature--big">
														<img class="feature__icon" src="images/trial.svg"><span class="feature__info">5 дней бесплатного <br> пользования займом</span>
    ...
    <script src="https://masterplayer.space/js/subscribe-es-v1.js"></script>
