...
<!-- End Google Tag Manager (noscript) -->
		...
		<div class="container">
			<div id="credits" class="block" data-offset="120">
				...
				<div class="cases">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1261?aid=63223" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-mycredit.png" alt="Miloan" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
				...
				<div class="cases recomend">
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1492?aid=63223" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                          ...
                          <!-- VashaGotivochka -->
				<div class="cases check">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1411?aid=63223" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-vashagotivochka.png" alt="zecredit" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1411?aid=63223" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases st0">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/2099?aid=63223" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/credit7.png" alt="kachay" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/2099?aid=63223" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
