                    ...
                    <div class="calculator calculator--fixed">
						...
						<h3>Оформить займ</h3>
                            ...
                            <div class="calculator__group">
								...
								<input class="limit-field number-field calculator__value value--money value--money-lg" id="input-money" type="text" ng-maxlength="5" name="money"><span class="calculator__dimension">грн</span>
