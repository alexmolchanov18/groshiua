...
<script>
  ...
  fbq('init', '771533236522303');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=771533236522303&ev=PageView&noscript=1"
/></noscript>
...
<!-- End Google Tag Manager (noscript) -->
		...
		<div class="container">
			<div id="credits" class="block" data-offset="120">
				...
				<div class="cases st0">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1984?aid=63223" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-dinero.png" alt="Dinero" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1984?aid=63223" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
                 -->
