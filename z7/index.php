...
<script>
  ...
  OneSignal.push(function() {
    OneSignal.init({
      appId: "73e03cf3-c6c2-4f8e-96dd-e3d13c60b4fc",
    });
  });
</script>        
	</head>
...
<!-- End Google Tag Manager (noscript) -->
		...
		<div class="container">
			<div id="credits" class="block" data-offset="120">
				...
				<div class="cases">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1272?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-shvidkogroshi.png" alt="ШвидкоГрошi" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1272?aid=65264" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1436?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-miloan.svg" alt="Miloan" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1436?aid=65264" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases recomend">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1492?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-creditkasa.png" alt="Credit Kasa" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1492?aid=65264" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<!--<div class="cases recomend">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1728?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/bizlogo.png" alt="BizPozika" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1728?aid=65264" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div> -->
				...
				<div class="cases st0">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1710?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/kachay-logo.png" alt="kachay" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1710?aid=65264&dlink=https://cashinski.com.ua/ru/june-bomb/" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases st0">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1571?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-dinero.png" alt="Dinero" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1571?aid=65264" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases st0">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1610?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-forza.png" alt="Forza" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1610?aid=65264" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases zerro">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/250?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-moneyveo.png" alt="Moneyveo" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/250?aid=65264" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
				...
				<div class="cases zerro">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1509?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-alexcredit.png" alt="AlexCredit" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1509?aid=65264" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>
			...
			<div id="banners">
				<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/250?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/banner-moneyveo.jpg" alt="Moneyveo"/></a>
				<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1509?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/banner-alexcredit.jpg" alt="AlexCredit"/></a>
			</div>
			...
			<div class="container">
				<div class="brands">
					<ul class="responsive item" id="brands">
						<li><a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/250?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img alt="Moneyveo" src="img/logo-moneyveo.png" /></a></li>
                        <li><a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1571?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img alt="Dinero" src="img/logo-dinero.png" /></a></li>
                        <li><a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1492?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img alt="CreditKasa" src="img/logo-creditkasa.png" /></a></li>
						<li><a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1338?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img alt="SOS Credit" src="img/logo-sos-credit.svg" /></a></li>
						<li><a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1509?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img alt="AlexCredit" src="img/logo-alexcredit.png" /></a></li>
						<li><a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1559?aid=65264" onclick="fbq('track', 'Lead');" target="_blank"><img alt="KF.UA" src="img/logo-kfua.png" /></a></li>
                        <li><a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1556?aid=65264" onclick="fbq('track', 'Lead');" onclick="fbq('track', 'Lead');" target="_blank"><img alt="Cash in Sky" src="img/logo-cashinsky.png" /></a></li>
