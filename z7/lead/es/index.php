                ...
                <div class="hero-calc">
                    ...
                    <div class="calculator calculator--fixed">
						...
						<h3>Créditos rápidos al instante</h3>
                                                    ...
                                                    <fieldset class="form__field">
                                                        <div class="form__wrap">
                                                            <input class="form__input ng-pristine ng-untouched ng-valid-mask ng-empty ng-invalid ng-invalid-required" id="phone" name="phone" type="tel" value="">
                            ...
                            <div class="calculator__group">
								...
								<input class="limit-field number-field calculator__value value--money value--money-lg" id="input-money" type="text" ng-maxlength="5" name="money"><span class="calculator__dimension">EUR</span>
								<div class="range-slider"  id="slider-money" data-value="500" data-min="500" data-max="3000"></div>
								<div class="range-wrapper">
									<div class="range__label range--bottom">500 EUR</div>
									<div class="range__label range--top">3 000 EUR</div>
								</div>
							</div>
						</div>
						<div class="calculator__preivew">
                            ...
                            <a 
onclick="fbq('track', 'Lead');" class="btn btn--primary btn--lg" href="https://go.salesdoubler.net/in/offer/1743?aid=65264&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $promo;?>&tid1=<?php echo $medium;?>&tid2=<?php echo $term;?>>">¡Solicita!</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="block">
				...
				<div class="centered-block"><a class="btn btn--primary btn--effect" onclick="fbq('track', 'Lead');" href="https://go.salesdoubler.net/in/offer/1743?aid=65264&source=<?php echo $source;?>&campaign=<?php echo $campaign;?>&promo=<?php echo $promo;?>&tid1=<?php echo $medium;?>&tid2=<?php echo $term;?>>">¡Solicitar!</a>
				</div>
			</div>
		</div>
		<!--<div class="box">
