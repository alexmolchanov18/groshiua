...
<head>
	<meta charset="utf-8">
	<title>Онлайн-кредит на карту, не выходя из дома</title>
                ...
                <div class="hero-calc">
                    ...
                    <div class="calculator calculator--fixed">
						...
						<h3>Оформить кредит</h3>
							...
							<fieldset class="form__field">
								<div class="form__wrap">
									<input class="form__input ng-pristine ng-untouched ng-empty ng-valid-email ng-invalid ng-invalid-required ng-valid-pattern" id="inn" name="inn_code" type="text">
									<label class="form__label" for="inn">ИНН</label>
								</div>
							</fieldset>
							<p class="innText">Указав ИНН вы повышаете вероятность получения займа на 40%</p>
                        ...
                        <input type="hidden" name="access-token" value="31640a9cac86e77de68f43edced7fedd"/>
