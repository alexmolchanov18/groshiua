               ...
               <!-- CreditKasa -->
				...
				<div class="cases recomend">
					...
					<div>
						...
						<div class="rate rate45" data-toggle="tooltip" data-placement="top" title="Рейтинг: 5"></div>
					</div>
					<div>
						<p class="thead">
							На срок
				...
				<div class="cases recomend">
					<div class="cases-logo">
						<a class="rdr" href="#" data-href="//go.salesdoubler.net/in/offer/1849?aid=63223" onclick="fbq('track', 'Lead');" target="_blank"><img src="img/logo-sos-credit.svg" alt="BizPozika" /></a>
					</div>
					<div>
						<p class="thead">
							Рейтинг
					...
					<div class="go">
						<a href="#" data-href="//go.salesdoubler.net/in/offer/1849?aid=63223" onclick="fbq('track', 'Lead');" target="_blank" class="rdr btn btn-success">Полу&shy;чить займ <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
					</div>
				</div>-->
