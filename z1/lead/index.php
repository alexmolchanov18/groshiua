...
<script>
  ...
  fbq('init', '1076655689164624');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=1076655689164624&ev=PageView&noscript=1"
/></noscript>
		...
		<header class="header">
			<div class="header-offscreen">
				<div class="top-section">
					<div class="cta cta--sm"><a class="btn btn--primary btn-effect" href="#" data-toggle="modal" data-target="#modal-goto">Оформить займ</a>
					</div>
								...
								<div class="container">
									<div class="row">
										<div class="col-sm-6 col-lg-7">
											<h3 class="hero__title">Онлайн займ на&nbsp;карту не&nbsp;выходя из&nbsp;дома</h3>
											<p class="hero__text">Для новых клиентов — займ от&nbsp;0%</p>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="container relative">
                ...
                <div class="hero-calc">
                    ...
                    <div class="calculator calculator--fixed">
                        ...
                        <input type="hidden" name="access-token" value="6643fc5ba5413d74e388e20cba50d834"/>
							...
							<div class="row hidden-xs">
								<div class="col-sm-6 col-md-3">
									<div class="feature feature--big">
										...
										</div><span class="feature__count">1</span><span class="feature__info">Выберите необходимые <br> сумму и срок займа</span>
